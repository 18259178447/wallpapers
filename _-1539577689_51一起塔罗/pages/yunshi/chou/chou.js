...
Page({
    ...
    checkPeidui: function() {
        ...
        a.data.p_user_id && !this.data.option.tiao_type && (s.scene = "pages/yunshi/chou/chou?fr_user_id=" + a.data.p_user_id), 
        wx.request({
            ...
            success: function(t) {
                console.log(t), t.data.checked ? wx.navigateTo({
                    url: "/pages/yunshi/match?p_user_id=" + a.data.p_user_id
                }) : a.setData({
                    que: !0
                });
            }
    ...
    getResult: function() {
        ...
        wx.showLoading({
            ...
            url: t.yu + "/index.php/YunShi/getRandCard",
            data: {
                auth: t.auth.auth,
                secert: t.secert
            },
            ...
            success: function(t) {
                ...
                for (var s = [], e = 0; e < 5; e++) s.push(t.data.card.card_pic);
                a.setData({
                    outpai: s
                });
            }
    ...
    onLoad: function(s) {
        t.chou = !1;
        var e = this;
        this.ready(!0), this.xuanpai(), this.setData({
            yu: t.yu
        ...
        this.setData({
            paizhen: i[0]
        }), a.src = "https://weitaluo.xingpei360.com/Public/Api/mp3/yunshi.mp3", a.play(), 
        s.fr_user_id ? wx.getSetting({
            success: function(a) {
    ...
    select: function(t) {
        if (this.data.canselect) {
            if (this.data.cuss != this.data.paizhen.count) {
                var s = parseInt(t.currentTarget.dataset.id), e = this.data.status1;
                this.data.show;
