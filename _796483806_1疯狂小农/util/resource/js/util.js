...
util.base64Encode = function(e) {
    ...
    var n = e, a = wx.getStorageSync("userInfo").sessionid;
    if (-1 == n.indexOf("http://") && -1 == n.indexOf("https://") && (n = util.url(n)), 
    getUrlParam(n, "state") || e.data && e.data.state || !a || (n = n + "&state=we7sid-" + a), 
    !e.data || !e.data.m) {
        getCurrentPages();
        n = n + "&m=" + t;
    }
    var r = getSign(n, e.data);
    return r && (n = n + "&sign=" + r), n;
    ...
    !a.data || !a.data.m) {
        ...
        o.length && (o = o[getCurrentPages().length - 1]) && o.__route__ && (i += "&m=kundian_farm");
    }
  ...
  var e = {
    data: {
      ...
      "data": {
        ...
        "message": "",
        "data": {
          "sessionid": "aeb9d60c6f334b7f4607ee2bd7deb764",
          "userinfo": {
            "fanid": "173785",
            "acid": "70",
            "uniacid": "70",
            "uid": "118672",
            "openid": "oC-DE5P09vK4CtoKMHqB-pq7b7ZY",
            "nickname": "Smile .\u00b7 Alone",
            "groupid": "",
            "salt": "LlbQ8ulb",
            "follow": "1",
            "followtime": "1558414296",
            "unfollowtime": "0",
            "tag": {
              "subscribe": 1,
              "openid": "oC-DE5P09vK4CtoKMHqB-pq7b7ZY",
              ...
              "province": "Fujian",
              "country": "China",
              "avatar": "https:\/\/wx.qlogo.cn\/mmopen\/vi_32\/DYAIOgq83erNImZO2vXV3xocDiblZwDnlYqXMJeUbvatQE8G5zk1KAD3ONEK8iawOM7RCGtjrH4MV74IpC61BAGQ\/132"
            },
            "updatetime": "1558414296",
            "unionid": "",
            "sex": 1,
            "gender": 1,
            "headimgurl": "https:\/\/wx.qlogo.cn\/mmopen\/vi_32\/DYAIOgq83erNImZO2vXV3xocDiblZwDnlYqXMJeUbvatQE8G5zk1KAD3ONEK8iawOM7RCGtjrH4MV74IpC61BAGQ\/132",
            "avatar": "https:\/\/wx.qlogo.cn\/mmopen\/vi_32\/DYAIOgq83erNImZO2vXV3xocDiblZwDnlYqXMJeUbvatQE8G5zk1KAD3ONEK8iawOM7RCGtjrH4MV74IpC61BAGQ\/132"
          },
          "openid": "oC-DE5P09vK4CtoKMHqB-pq7b7ZY"
        }
  ...
  wx.hideLoading(), e.data.errno || (n.sessionid = e.data.data.sessionid, n.memberInfo = e.data.data.userinfo,
    ...
    var e = {
      data: {
        ...
        "data": {
          ...
          "uniacid": "70",
          "mobile": "",
          "email": "af0cd266924ef24c1a7cb313ce5b2df7@we7.cc",
          "groupid": "0",
          "credit1": 0,
          "credit2": 0,
          "credit3": 0,
